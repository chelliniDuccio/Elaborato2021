                ...
                <form class="row g-3 needs-validation" action="../actions/postUser.php" novalidate method="POST">
                    ...
                    <div class="row g-1">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="range" class="form-range" min="1" max="5" id="rangeStart" oninput="this.nextElementSibling.value = this.value">
                            <output>3</output>
                            <i class="bi-star-fill m-2"></i>
                        </div>
                        <div class="col-md-12">
                            <label for="customRange2" class="form-label">Costo massimo (per notte)</label>
                            <input type="range" class="form-range" min="20" max="320" step="20" id="priceRange" oninput="this.nextElementSibling.value = this.value">
                            <output>3</output>
